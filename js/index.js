...
function Platform() {
	...
	if (score >= 5000) this.types = [1, 3, 1, 3, 1, 3, 1, 3];
	else if (score >= 2000 && score < 5000) this.types = [1, 3, 1, 3, 1, 3, 1, 3, 1, 3, 1];
	else if (score >= 1000 && score < 2000) this.types = [3, 1, 3, 1, 3, 1, 3, 1];
	else if (score >= 500 && score < 1000) this.types = [1, 3, 1, 3, 1, 3, 1, 3, 1, 3, 1, 3, 1];
	else if (score >= 100 && score < 500) this.types = [3, 1, 3, 1, 3, 1];
	else this.types = [1];
